...
$judul_mapel = relation('tb_m_mapel', 'id_mapel', $id_mapel)['nama'];
$materi = relation('tb_m_materi', 'id_materi', $id_materi);
?>
<!DOCTYPE html>
<html lang="en">
                        ...
                        <div class="row align-items-center">
                            <div class="col-xl-8 col-xxl-12">
                                <div class="text-center text-xl-start text-xxl-center mb-4 mb-xl-0 mb-xxl-4">
                                    <h1 class="text-primary"><?= $materi['judul'] ?></h1>
                                    <p class="text-gray-700 mb-0"><?= $materi['deskripsi'] ?></p>
                                </div>
                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                <a href="<?= base_url('siswa/konten/?id_mapel=' . $id_mapel . '&id_materi=' . $id_materi . '&id_submateri=' . $row['id_submateri']) ?>" class="btn btn-info">
