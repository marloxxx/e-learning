...
$id = $_GET['id'];
$sql = "SELECT * FROM tb_d_konten WHERE id_konten = $id";
$query = $con->prepare($sql);
$query->execute();
$result = $query->fetch(PDO::FETCH_ASSOC);
?>
<form id="form">
    <input type="hidden" name="id_submateri" value="<?= $id_submateri ?>">
    ...
    <div class="modal-body">
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <input class="form-control" id="file" name="file" type="file" placeholder="File Materi" value="<?= $result['file'] ?>">
            </div>
        </div>
    </div>
